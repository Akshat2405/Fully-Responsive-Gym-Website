...
import catalyzer from './image/catalyzer.png';
import blows from './image/400blows.png';
function Content() {
    return (
      <>
    ...
    <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
      <div className="p-4 md:w-1/3 sm:mb-0 mb-6">
        <div className="rounded-lg h-64 overflow-hidden">
          <img alt="content" className="object-cover object-center h-full w-full" src={shooting}/>
        </div>
        ...
        <a className="text-teal-500 inline-flex items-center mt-3">Learn More
      ...
      <div className="p-4 md:w-1/3 sm:mb-0 mb-6">
        <div className="rounded-lg h-64 overflow-hidden">
          <img alt="content" className="object-cover object-center h-full w-full" src={catalyzer}/>
        </div>
      ...
      <div className="p-4 md:w-1/3 sm:mb-0 mb-6">
        <div className="rounded-lg h-64 overflow-hidden">
          <img alt="content" className="object-cover object-center h-full w-full" src={blows}/>
        </div>
