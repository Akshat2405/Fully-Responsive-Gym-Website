        ...
        <section class="text-gray-700 body-font overflow-hidden">
                <div class="container px-5 py-24 mx-auto flex flex-wrap">
                    ...
                    <div class="mt-px border-t border-gray-300 border-b border-l rounded-tl-lg rounded-bl-lg overflow-hidden">
                        <p class="bg-gray-100 text-gray-900 h-12 text-center px-4 flex items-center justify-start -mt-px">Instructor</p>
                    ...
                    <div class="lg:w-1/3 lg:-mt-px w-full mb-10 lg:mb-0 border-2 rounded-lg border-teal-500 relative">
                        ...
                        <button class="flex items-center mt-auto text-white bg-teal-500 border-0 py-2 px-4 w-full focus:outline-none hover:bg-teal-600 rounded">Enroll
                    ...
                    <div class="lg:w-1/3 lg:-mt-px w-full mb-10 lg:mb-0 border-2 rounded-lg border-teal-500 relative">
                        <div class="px-2 text-center h-48 flex flex-col items-center justify-center">
                        <h3 class="tracking-widest">ATHLETES</h3>
